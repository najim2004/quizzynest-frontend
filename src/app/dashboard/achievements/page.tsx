...
const Achievement = () => {
  ...
  return (
    <motion.div variants={staggerContainer} initial="initial" animate="animate" className="p-4">
      <div className="flex flex-col justify-center items-center mb-8 p-2">
        ...
        <p className="text-muted-foreground text-sm">All achievements you&#39;ve earned</p>
      </div>
